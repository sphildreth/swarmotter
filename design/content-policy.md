...
This document states what SwarmOtter will not include. It applies to official
SwarmOtter repositories, documentation, examples, issue templates, discussions,
release artifacts, and project-hosted assets.
